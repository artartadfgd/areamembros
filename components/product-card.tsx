  ...
  return (
    <>
      <article
        ...
        className={cn(
          "group relative flex flex-col overflow-hidden rounded-xl border border-border bg-surface transition-all duration-300 hover:-translate-y-1 hover:border-border-strong hover:shadow-[0_16px_32px_-16px_rgb(var(--shadow-color)/0.35)]",
        ...
        <div className="flex flex-1 flex-col gap-3 p-5">
          ...
          <div className="flex items-center justify-between gap-3 pt-1">
            ...
            {isUnlocked ? (
              ...
              <span className="inline-flex items-center gap-1.5 rounded-md bg-accent px-4 py-2 text-sm font-medium text-accent-ink transition-colors group-hover:bg-accent-hover">
                {t("buyNow")}
              </span>
            )}
          </div>
